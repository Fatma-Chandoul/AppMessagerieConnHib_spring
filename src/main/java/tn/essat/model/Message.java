...
private boolean readfromreceive=false;
	public Message() {
		super();
	...
	public Message(Integer id, Utilisateur user_send, Utilisateur user_receive, String sujet, String contenu) {
		...
		this.readfromreceive=readfromreceive;
	}
	...
	public boolean isReadfromreceive() {
		return readfromreceive;
	}

	public void setReadfromreceive(boolean readfromreceive) {
		this.readfromreceive = readfromreceive;
	}
